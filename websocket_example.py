...
# 订单频道 Order Channel
# channels = [{"channel": "orders", "instType": "FUTURES", "uly": "BTC-USD", "instId": "BTC-USDT-SWAP"}]
...
# 下单 Place Order
trade_param = {"id": "1512", "op": "order", "args": [{"side": "buy", "instId": "BTC-USDT-SWAP", "tdMode": "cross", "ordType": "market", "sz": "1"}]}
